...
- `data_converter/`：AMASS/SMPL-H 到 `realtime_pose_v2_contact` 源数据的转换脚本。
- `data_loaders/`：`realtime_pose_v2_contact` task 生成、Dataset、normalizer、tracker pattern 规则。
...
- `eval/`：`realtime_pose_v2_contact` 评估入口和指标计算。
