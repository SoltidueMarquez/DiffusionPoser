...
- 历史实验记录中的 `realtime_pose_v2_contact` 已废弃；新实验应使用当前默认 `realtime_pose_stationary5_v1` stationary5 契约，`realtime_pose_body_fbx_local_root_y0_v1` 仅作为 legacy alias 保留。
