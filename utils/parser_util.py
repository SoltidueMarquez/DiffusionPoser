...
def add_data_options(parser: ArgumentParser):
    ...
    group.add_argument("--data_dir", required=True, type=str, help="realtime_pose source-reference task 目录。")
    ...
    group.add_argument("--source_cache_max_mib", default=512, type=int)
