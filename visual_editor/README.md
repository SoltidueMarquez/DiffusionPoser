...
- Source：`realtime_pose_body_fbx_local_root_y0_v1` `.npz`，包含 `body_pose_body_fbx_local_delta_6d/pose_representation/root_pos_world/root_yaw/root_heading_delta_sincos/root_delta_xz_ref/pelvis_height/stationary_prob_5/tracker_pos_world/tracker_rot_world_6d/joints_world/joint_offsets_parent/joint_rest_local_rotations_6d`。
