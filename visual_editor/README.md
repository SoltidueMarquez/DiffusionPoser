...
`visual_editor/` 是本地 realtime_pose_v2 查看和 task 导出工具。

## 启动 API

```powershell
conda run -n diffusionposer5070 python -m visual_editor.server --source_dir dataset/AMASS_realtime_pose_v2_60hz --data_dir dataset/AMASS_realtime_pose_v2_60hz_tasks --result_dir output --output_dir visual_editor/.runtime/exports
```
